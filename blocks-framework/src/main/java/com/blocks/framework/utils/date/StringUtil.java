...
public abstract class StringUtil {
	 ...
	 * 上面的方法不好用，必须先构�?�数组�?�改为下面的�?系列方法，支持到15个参数�??
	 * 
	 * @param pattern
	 *            message format pattern
	 * @param arg1
	...
	/**
	 * long转换成字符串，如果位数不足str长度，把str多余的值补齐


	 * 如 long2StringForLen(30,"000000")
	 * 返回 000030
	 * @param num
	 * @param str
	 * @return
    ...
    /**
     * 因为org.apache.commons.lang3.StringUtils里面有Thread.currentThread().getContextClassLoader()导致 在jni回调的时候 报错了描述: .
